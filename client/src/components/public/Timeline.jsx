...
export default function Timeline() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:block absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 rounded-full bg-[radial-gradient(circle,rgba(16,185,129,0.06)_0%,transparent_70%)] pointer-events-none -z-10" />
